    ...
    <footer className="bg-gradient-to-r from-lime-800 to-emerald-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <a href="https://www.instagram.com/harsh_final.aep/" className="hover:text-lime-300 transition-colors duration-300" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-8 pt-8 border-t border-lime-700 text-center">
          ...
          <p className="text-xs mt-2">Made with ❤️ by <a href="https://harsh-react-portfolio.vercel.app/" className="text-lime-300 hover:text-white transition-colors duration-300">Harsh Bharadiya</a></p>
