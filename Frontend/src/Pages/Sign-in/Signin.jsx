  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-200px)] bg-gradient-to-r from-zinc-700 to-zinc-900">
      <div className="bg-white p-8 rounded-lg shadow-md w-96">
        <h2 className="text-3xl font-bold mb-6 text-center text-zinc-800">Sign Up</h2>
        <form>
          <div className="mb-4">
          ...
          <p className='text-sm text-gray-500 mb-4 text-center'>Already have an Account? <NavLink to="/login" className='text-lime-700 cursor-pointer'>Login</NavLink></p>
          <button
            type="submit"
